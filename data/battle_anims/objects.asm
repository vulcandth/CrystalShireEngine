...
; BATTLE_ANIM_OBJ_ROCK_BLAST
	battleanimobj RELATIVE_X, $b8, BATTLE_ANIM_FRAMESET_BIG_ROCK_STAR_HEART, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_GFX_ROCKS 
