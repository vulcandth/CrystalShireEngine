...
; entries correspond to BATTLE_ANIM_OAMSET_* constants
	...
	battleanimoam $07, 10, .OAMData_be ; BATTLE_ANIM_OAMSET_BE
	...
	battleanimoam $15,  4, .OAMData_04 ; BATTLE_ANIM_OAMSET_DC
	battleanimoam $02,  2, .OAMData_dd ; BATTLE_ANIM_OAMSET_DD
	battleanimoam $00, 26, .OAMData_de ; BATTLE_ANIM_OAMSET_DE
	battleanimoam $00,  4, .OAMData_df ; BATTLE_ANIM_OAMSET_DF
	battleanimoam $04,  6, .OAMData_e0 ; BATTLE_ANIM_OAMSET_E0
	battleanimoam $0a,  5, .OAMData_e1 ; BATTLE_ANIM_OAMSET_E1
	battleanimoam $00, 16, .OAMData_e2 ; BATTLE_ANIM_OAMSET_E2
	battleanimoam $10, 16, .OAMData_e2 ; BATTLE_ANIM_OAMSET_E3
	battleanimoam $20, 16, .OAMData_e2 ; BATTLE_ANIM_OAMSET_E4
	battleanimoam $30, 16, .OAMData_e2 ; BATTLE_ANIM_OAMSET_E5
	battleanimoam $12, 16, .OAMData_e6 ; BATTLE_ANIM_OAMSET_E6
	battleanimoam $00, 36, .OAMData_e7 ; BATTLE_ANIM_OAMSET_E7
	battleanimoam $09, 16, .OAMData_00 ; BATTLE_ANIM_OAMSET_E8
	battleanimoam $06,  9, .OAMData_e9 ; BATTLE_ANIM_OAMSET_E9
	battleanimoam $00, 17, .OAMData_ea ; BATTLE_ANIM_OAMSET_EA
	battleanimoam $02,  8, .OAMData_eb ; BATTLE_ANIM_OAMSET_EB
	battleanimoam $06, 10, .OAMData_ec ; BATTLE_ANIM_OAMSET_EC
	battleanimoam $0b, 10, .OAMData_ec ; BATTLE_ANIM_OAMSET_ED
	battleanimoam $00, 16, .OAMData_ee ; BATTLE_ANIM_OAMSET_EE
	battleanimoam $08, 16, .OAMData_ee ; BATTLE_ANIM_OAMSET_EF
	battleanimoam $10, 16, .OAMData_ee ; BATTLE_ANIM_OAMSET_F0
	battleanimoam $18, 16, .OAMData_ee ; BATTLE_ANIM_OAMSET_F1
	...
	battleanimoam $0f,  1, .OAMData_0f ; BATTLE_ANIM_OAMSET_FE
