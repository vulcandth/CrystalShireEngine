...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_WARP                    ; 43
	const BATTLE_ANIM_OBJ_ABSORB                  ; 44
	const BATTLE_ANIM_OBJ_EGG                     ; 45
	const BATTLE_ANIM_OBJ_FOCUS                   ; 46
	const BATTLE_ANIM_OBJ_BIND1                   ; 47
	const BATTLE_ANIM_OBJ_BIND2                   ; 48
	const BATTLE_ANIM_OBJ_LEECH_SEED              ; 49
	const BATTLE_ANIM_OBJ_SOUND                   ; 4a
	const BATTLE_ANIM_OBJ_WAVE                    ; 4b
	const BATTLE_ANIM_OBJ_CONFUSE_RAY             ; 4c
	const BATTLE_ANIM_OBJ_LEER                    ; 4d
	const BATTLE_ANIM_OBJ_LEER_TIP                ; 4e
	const BATTLE_ANIM_OBJ_SCREEN                  ; 4f
	const BATTLE_ANIM_OBJ_CHICK                   ; 50
	const BATTLE_ANIM_OBJ_AMNESIA                 ; 51
	const BATTLE_ANIM_OBJ_ASLEEP                  ; 52
	const BATTLE_ANIM_OBJ_SKULL                   ; 53
	const BATTLE_ANIM_OBJ_DIG_SAND                ; 54
	const BATTLE_ANIM_OBJ_DIG_PILE                ; 55
	const BATTLE_ANIM_OBJ_SAND                    ; 56
	const BATTLE_ANIM_OBJ_PARALYZED               ; 57
	const BATTLE_ANIM_OBJ_STRING_SHOT             ; 58
	const BATTLE_ANIM_OBJ_HAZE                    ; 59
	const BATTLE_ANIM_OBJ_MIST                    ; 5a
	const BATTLE_ANIM_OBJ_SMOG                    ; 5b
	const BATTLE_ANIM_OBJ_POISON_GAS              ; 5c
	const BATTLE_ANIM_OBJ_HORN                    ; 5d
	const BATTLE_ANIM_OBJ_NEEDLE                  ; 5e
	const BATTLE_ANIM_OBJ_PETAL_DANCE             ; 5f
	const BATTLE_ANIM_OBJ_SLUDGE_BOMB             ; 60
	const BATTLE_ANIM_OBJ_PAY_DAY                 ; 61
	const BATTLE_ANIM_OBJ_MIMIC                   ; 62
	const BATTLE_ANIM_OBJ_ATTRACT                 ; 63
	const BATTLE_ANIM_OBJ_BONEMERANG              ; 64
	const BATTLE_ANIM_OBJ_BONE_CLUB               ; 65
	const BATTLE_ANIM_OBJ_BONE_RUSH               ; 66
	const BATTLE_ANIM_OBJ_SWIFT                   ; 67
	const BATTLE_ANIM_OBJ_KINESIS                 ; 68
	const BATTLE_ANIM_OBJ_FLASH                   ; 69
	const BATTLE_ANIM_OBJ_SHINY                   ; 6a
	const BATTLE_ANIM_OBJ_SKY_ATTACK              ; 6b
	const BATTLE_ANIM_OBJ_LICK                    ; 6c
	const BATTLE_ANIM_OBJ_WITHDRAW                ; 6d
	const BATTLE_ANIM_OBJ_DRAIN                   ; 6e
	const BATTLE_ANIM_OBJ_GROWTH                  ; 6f
	const BATTLE_ANIM_OBJ_CONVERSION2             ; 70
	const BATTLE_ANIM_OBJ_SMOKE                   ; 71
	const BATTLE_ANIM_OBJ_SMOKESCREEN             ; 72
	const BATTLE_ANIM_OBJ_SWORDS_DANCE            ; 73
	const BATTLE_ANIM_OBJ_SPEED_LINE              ; 74
	const BATTLE_ANIM_OBJ_SHARPEN                 ; 75
	const BATTLE_ANIM_OBJ_DEFENSE_CURL            ; 76
	const BATTLE_ANIM_OBJ_METRONOME_HAND          ; 77
	const BATTLE_ANIM_OBJ_METRONOME_SPARKLE       ; 78
	const BATTLE_ANIM_OBJ_DISABLE                 ; 79
	const BATTLE_ANIM_OBJ_AGILITY                 ; 7a
	const BATTLE_ANIM_OBJ_HEART                   ; 7b
	const BATTLE_ANIM_OBJ_FLAME_WHEEL             ; 7c
	const BATTLE_ANIM_OBJ_SACRED_FIRE             ; 7d
	const BATTLE_ANIM_OBJ_COTTON_SPORE            ; 7e
	const BATTLE_ANIM_OBJ_MILK_DRINK              ; 7f
	const BATTLE_ANIM_OBJ_ANGER                   ; 80
	const BATTLE_ANIM_OBJ_HEAL_BELL               ; 81
	const BATTLE_ANIM_OBJ_HEAL_BELL_NOTE          ; 82
	const BATTLE_ANIM_OBJ_BATON_PASS              ; 83
	const BATTLE_ANIM_OBJ_LOCK_ON                 ; 84
	const BATTLE_ANIM_OBJ_MIND_READER             ; 85
	const BATTLE_ANIM_OBJ_SAFEGUARD               ; 86
	const BATTLE_ANIM_OBJ_PROTECT                 ; 87
	const BATTLE_ANIM_OBJ_THIEF                   ; 88
	const BATTLE_ANIM_OBJ_OCTAZOOKA               ; 89
	const BATTLE_ANIM_OBJ_PRESENT                 ; 8a
	const BATTLE_ANIM_OBJ_SPIKES                  ; 8b
	const BATTLE_ANIM_OBJ_POWDER_SNOW             ; 8c
	const BATTLE_ANIM_OBJ_DRAGONBREATH            ; 8d
	const BATTLE_ANIM_OBJ_CONVERSION              ; 8e
	const BATTLE_ANIM_OBJ_SPIDER_WEB              ; 8f
	const BATTLE_ANIM_OBJ_NIGHTMARE               ; 90
	const BATTLE_ANIM_OBJ_IN_NIGHTMARE            ; 91
	const BATTLE_ANIM_OBJ_LOVELY_KISS             ; 92
	const BATTLE_ANIM_OBJ_SWEET_KISS              ; 93
	const BATTLE_ANIM_OBJ_SKETCH                  ; 94
	const BATTLE_ANIM_OBJ_ENCORE_HAND             ; 95
	const BATTLE_ANIM_OBJ_ENCORE_STAR             ; 96
	const BATTLE_ANIM_OBJ_DESTINY_BOND            ; 97
	const BATTLE_ANIM_OBJ_MORNING_SUN             ; 98
	const BATTLE_ANIM_OBJ_GLIMMER                 ; 99
	const BATTLE_ANIM_OBJ_MOONLIGHT               ; 9a
	const BATTLE_ANIM_OBJ_HIDDEN_POWER            ; 9b
	const BATTLE_ANIM_OBJ_CROSS_CHOP1             ; 9c
	const BATTLE_ANIM_OBJ_CROSS_CHOP2             ; 9d
	const BATTLE_ANIM_OBJ_SANDSTORM               ; 9e
	const BATTLE_ANIM_OBJ_ZAP_CANNON              ; 9f
	const BATTLE_ANIM_OBJ_SPITE                   ; a0
	const BATTLE_ANIM_OBJ_CURSE                   ; a1
	const BATTLE_ANIM_OBJ_PERISH_SONG             ; a2
	const BATTLE_ANIM_OBJ_FORESIGHT               ; a3
	const BATTLE_ANIM_OBJ_RAPID_SPIN              ; a4
	const BATTLE_ANIM_OBJ_SWAGGER                 ; a5
	const BATTLE_ANIM_OBJ_BELLY_DRUM_HAND         ; a6
	const BATTLE_ANIM_OBJ_BELLY_DRUM_NOTE         ; a7
	const BATTLE_ANIM_OBJ_MEAN_LOOK               ; a8
	const BATTLE_ANIM_OBJ_SHOOTING_SPARKLE        ; a9
	const BATTLE_ANIM_OBJ_RAIN                    ; aa
	const BATTLE_ANIM_OBJ_B0                      ; ab
	const BATTLE_ANIM_OBJ_PSYCH_UP                ; ac
	const BATTLE_ANIM_OBJ_ANCIENTPOWER            ; ad
	const BATTLE_ANIM_OBJ_AEROBLAST               ; ae
	const BATTLE_ANIM_OBJ_SHADOW_BALL             ; af
	const BATTLE_ANIM_OBJ_ROCK_SMASH              ; b0
	const BATTLE_ANIM_OBJ_FLOWER                  ; b1
	const BATTLE_ANIM_OBJ_COTTON                  ; b2
	const BATTLE_ANIM_OBJ_ENEMYFEET_1ROW          ; b3
	const BATTLE_ANIM_OBJ_PLAYERHEAD_1ROW         ; b4
	const BATTLE_ANIM_OBJ_ENEMYFEET_2ROW          ; b5
	const BATTLE_ANIM_OBJ_PLAYERHEAD_2ROW         ; b6
	const BATTLE_ANIM_OBJ_PALM_XFLIP              ; b7
	const BATTLE_ANIM_OBJ_MEDIUM_HORN             ; b8
	const BATTLE_ANIM_OBJ_MINIMIZE                ; b9
	const BATTLE_ANIM_OBJ_DAZZLE                  ; ba
	const BATTLE_ANIM_OBJ_EGG_BOMB                ; bb
	const BATTLE_ANIM_OBJ_BUBBLE_SPLASH           ; bc
	const BATTLE_ANIM_OBJ_RISING_BUBBLE           ; bd
	const BATTLE_ANIM_OBJ_OCTAZOOKA_SMOKE         ; be
	const BATTLE_ANIM_OBJ_INK_SPLASH              ; bf
	const BATTLE_ANIM_OBJ_FAKE_OUT_L              ; c0
	const BATTLE_ANIM_OBJ_FAKE_OUT_R              ; c1
	const BATTLE_ANIM_OBJ_SMELLINGSALT_L          ; c2
	const BATTLE_ANIM_OBJ_SMELLINGSALT_R          ; c3
	const BATTLE_ANIM_OBJ_SMELLINGSALT_SHOCK      ; c4
	const BATTLE_ANIM_OBJ_BIG_WAVE                ; c5
	const BATTLE_ANIM_OBJ_UPROAR                  ; c6
	const BATTLE_ANIM_OBJ_ENERGY_ORB              ; c7
	const BATTLE_ANIM_OBJ_ENERGY_ORB_OUT          ; c8
	const BATTLE_ANIM_OBJ_ENERGY_ORB_OUT_YFIX     ; c9
	const BATTLE_ANIM_OBJ_MIST_BG                 ; ca
	const BATTLE_ANIM_OBJ_HAIL                    ; cb
	const BATTLE_ANIM_OBJ_TORMENT                 ; cc
	const BATTLE_ANIM_OBJ_FLATTER_1               ; cd
	const BATTLE_ANIM_OBJ_FLATTER_2               ; ce
	const BATTLE_ANIM_OBJ_DROPLET_R               ; cf
	const BATTLE_ANIM_OBJ_DROPLET_L               ; d0
	const BATTLE_ANIM_OBJ_LONG_PUNCH              ; d1
	const BATTLE_ANIM_OBJ_CHARGE                  ; d2
	const BATTLE_ANIM_OBJ_TAUNT                   ; d3
	const BATTLE_ANIM_OBJ_TRICK                   ; d4
	const BATTLE_ANIM_OBJ_WISH_1                  ; d5
	const BATTLE_ANIM_OBJ_WISH_2                  ; d6
	const BATTLE_ANIM_OBJ_COSMIC_POWER_BG         ; d7
	const BATTLE_ANIM_OBJ_ASSIST                  ; d8
	const BATTLE_ANIM_OBJ_ROOT_L                  ; d9
	const BATTLE_ANIM_OBJ_ROOT_R                  ; da
	const BATTLE_ANIM_OBJ_ENERGY_INGRAIN          ; db
	const BATTLE_ANIM_OBJ_RECYCLE                 ; dc
	const BATTLE_ANIM_OBJ_VERTICAL_CHOP           ; dd
	const BATTLE_ANIM_OBJ_VERTICAL_CHOP_STILL     ; de
	const BATTLE_ANIM_OBJ_YAWN_1                  ; df
	const BATTLE_ANIM_OBJ_YAWN_2                  ; e0
	const BATTLE_ANIM_OBJ_ROCK_TOMB               ; e1
	const BATTLE_ANIM_OBJ_ERUPTION_BIG_ROCK       ; e2
	const BATTLE_ANIM_OBJ_ERUPTION_SMALL_ROCK     ; e3
	const BATTLE_ANIM_OBJ_ERUPTION_SMALL_FLAME    ; e4
	const BATTLE_ANIM_OBJ_SKILL_SWAP_1            ; e5
	const BATTLE_ANIM_OBJ_SKILL_SWAP_2            ; e6
	const BATTLE_ANIM_OBJ_IMPRISON_RING           ; e7
	const BATTLE_ANIM_OBJ_RED_X                   ; e8
	const BATTLE_ANIM_OBJ_DESCENDING_SPARKLE      ; e9
	const BATTLE_ANIM_OBJ_GRUDGE                  ; ea
	const BATTLE_ANIM_OBJ_SNATCH_1                ; eb
	const BATTLE_ANIM_OBJ_SNATCH_2                ; ec
	const BATTLE_ANIM_OBJ_SMALL_GLOW              ; ed
	const BATTLE_ANIM_OBJ_BIG_GLOW                ; ee
	const BATTLE_ANIM_OBJ_FEATHERDANCE            ; ef
	const BATTLE_ANIM_OBJ_TEETER_DANCE            ; f0
	const BATTLE_ANIM_OBJ_RADIAL_FLAME_SLOW       ; f1
	const BATTLE_ANIM_OBJ_MUD_SPORT_1             ; f2
	...
	const BATTLE_ANIM_OBJ_CLAW_TEAR               ; fe
