...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const BATTLE_ANIM_OBJ_RECYCLE                 ; e0
	const BATTLE_ANIM_OBJ_VERTICAL_CHOP           ; e1
	const BATTLE_ANIM_OBJ_VERTICAL_CHOP_STILL     ; e2
	const BATTLE_ANIM_OBJ_YAWN_1                  ; e3
	const BATTLE_ANIM_OBJ_YAWN_2                  ; e4
	const BATTLE_ANIM_OBJ_ROCK_TOMB               ; e5
	const BATTLE_ANIM_OBJ_ERUPTION_BIG_ROCK       ; e6
	const BATTLE_ANIM_OBJ_ERUPTION_SMALL_ROCK     ; e7
	const BATTLE_ANIM_OBJ_ERUPTION_SMALL_FLAME    ; e8
	const BATTLE_ANIM_OBJ_SKILL_SWAP_1            ; e9
	const BATTLE_ANIM_OBJ_SKILL_SWAP_2            ; ea
	const BATTLE_ANIM_OBJ_IMPRISON_RING           ; eb
	const BATTLE_ANIM_OBJ_RED_X                   ; ec
	const BATTLE_ANIM_OBJ_DESCENDING_SPARKLE      ; ed
	...
	const BATTLE_ANIM_OBJ_TEETER_DANCE            ; f4
	const BATTLE_ANIM_OBJ_RADIAL_FLAME_SLOW       ; f5
	const BATTLE_ANIM_OBJ_MUD_SPORT_1             ; f6
	const BATTLE_ANIM_OBJ_MUD_SPORT_2             ; f7
	const BATTLE_ANIM_OBJ_ICE_BALL                ; f8
	const BATTLE_ANIM_OBJ_ICE_SPLASH              ; f9
...
; DoBattleAnimFrame arguments (see engine/battle_anims/functions.asm)
	...
	const BATTLE_ANIM_FUNC_ROCK_TOMB                          ; 59
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLE_ANIM_FRAMESET_RECYCLE               ; d1
	const BATTLE_ANIM_FRAMESET_VERTICAL_CHOP         ; d2
	const BATTLE_ANIM_FRAMESET_DROWZINESS            ; d3
	const BATTLE_ANIM_FRAMESET_IMPRISON_RING         ; d4
	...
	const BATTLE_ANIM_FRAMESET_BIG_GLOW              ; d9
	const BATTLE_ANIM_FRAMESET_TEETER_DANCE          ; da
	const BATTLE_ANIM_FRAMESET_BURNED_SHORT          ; db
	const BATTLE_ANIM_FRAMESET_ICE_BALL              ; dc
