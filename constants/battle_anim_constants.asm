...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	; New Objects
	const BATTLE_ANIM_OBJ_PALM_XFLIP          ; bc
	const BATTLE_ANIM_OBJ_MEDIUM_HORN         ; bd
	const BATTLE_ANIM_OBJ_MINIMIZE            ; be
...
; the first 6 matches PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_WATER          ; 9
	const PAL_BTLCUSTOM_BUBBLE         ; a
	const PAL_BTLCUSTOM_AURORA         ; b
	const PAL_BTLCUSTOM_GLOBE          ; c
	const PAL_BTLCUSTOM_SPORE          ; d
